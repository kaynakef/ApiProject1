...
public class DeleteUser_StepDef {
    ...
    public void user_sets_user_id_and_sends_a_delete_http_request_and_validates_the_status() {
        response = requestSpecification
                .when().delete(ConfigReader.readProperty("baseURI")+ConfigReader.readProperty("usersPath")+userId).then().log().body().statusCode(200).extract().response();
    ...
    public void user_sets_non_exist_user_id_and_sends_a_delete_http_request_and_validates_the_status(int userId) {
        response = requestSpecification
                .when().delete(ConfigReader.readProperty("baseURI")+ConfigReader.readProperty("usersPath")+userId).then().statusCode(200).extract().response();
